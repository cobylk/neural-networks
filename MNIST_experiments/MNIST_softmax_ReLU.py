...
class SimpleNN(nn.Module):
    def __init__(self, harmonic=False, n=28., hidden_dim=100, temperature=1.0, ReLU=True, softmax=True):
...
def main(args):
    ...
    # Initialize model
    model = SimpleNN(harmonic=args.harmonic, n=args.n, hidden_dim=args.hidden_dim, temperature=args.temperature, ReLU=args.ReLU, softmax=args.softmax).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ReLU', type=bool, default=False,
                        help='use ReLU instead of linear (default: False)')
    parser.add_argument('--softmax', type=bool, default=False,
                        help='use softmax instead of linear (default: False)')
